...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/searchV4/css/goods.css" rel="stylesheet">
    
    
    <script src="http://style.571xz.com/global/js/jquery.js"></script>
<script src="http://style.571xz.com/searchV4/js/goods.js"></script>
  </head>
<body>
    ...
    <div class="layout navCon">
        <div class="navList">
            <ul>
                ...
                <li class="select"><a href="http://so.571xz.com/hzgoods.htm" target="_blank">商品库</a></li>
