    ...
    <div class="cttlfbox">
        ...
        <div class="otherFilterBox">
            <label><input id="toggleBpicFilter" type="checkbox" <#if query.bpic?? && query.bpic == "1">checked</#if>> 大图下载</label>
             <label><input id="toggleGoodsVedioFilter" type="checkbox" <#if query.goodsVedio?? && query.goodsVedio == "1">checked</#if>> 视频商品</label>
        </div>
