...
<html>
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>星座搜索 - 四季星座网 - 搜索(男装、女装、男鞋、女鞋代理平台)</title>
    ...
    <link href="http://style.571xz.com/searchV4/css/search.css" rel="stylesheet">
    
    
    <script src="http://style.571xz.com/global/js/jquery.js"></script>
<script src="http://style.571xz.com/searchV4/js/search.js"></script>
  </head>
<body>
        ...
        <div class="topShopList">
            ...
            <div class="shopbox">
                ...
                <div class="r3">
                    ...
                    <a class="a2" href="http://${webSite!}.571xz.com/shop.htm?id=${shop.storeId!}" target="_blank">进入店铺</a>
                </div>
                <div class="r4">
        ...
        <div class="formFilterBar clearfix" id="formFilterBar">
            ...
            <div class="rtbox">
                ...
                <div class="sortTimeBox">
                    ...
                    <div class="hoverBox">
                        <div class="innerbox">
                            <b jbtn="searchTime" d="">全部</b>
                            <b jbtn="searchTime" d="1">1日内</b>
                            <b jbtn="searchTime" d="7">1周内</b>
                            <b jbtn="searchTime" d="30">1月内</b>
                            <b jbtn="searchTime" d="90">3月内</b>
                            <b jbtn="searchTime" d="180">6月内</b>
                            <b jbtn="searchTime" d="365">1年内</b>
                        </div>
                    </div>
                </div>
        ...
        <div class="goodslistWindow clearfix">
             ...
             <div class="goodsitem" data-goodsid="${goods.id!}">
                ...
                <p class="p1">
                    ...
                    <p class="goodsNo"><a href="http://${webSite!}.571xz.com/item.htm?id=${goods.id!}" target="_blank" title="${goods.goodsNo!}">货号：${goods.highLightGoodsNo!}</a></p>
                    <#else>
                    <p class="title"><a href="http://${webSite!}.571xz.com/item.htm?id=${goods.id!}" target="_blank" title="${goods.title!}">${goods.highLightTitle!}</a></p>
                    </#if>
                <div class="p3">
...
<#assign $it=text?eval />
        ...
        <script>/*============ searchV4/page#goodslistWindow BEGIN ============*/
...
/*============ searchV4/page#goodslistWindow END ============*/
