    ...
    <#if (goodslist?size) gt 0>
        <div class="goodsList clearfix">
             ...
             <div class="goodsitem" data-goodsid="${goods.id!}">
                ...
                <div class="p3">
                    <span class="storeName"><a href="http://www.571xz.com/shop.htm?id=${goods.storeid!}" target="_blank" title="${goods.fullStoreName!}"><i class="icon1p"></i>${goods.fullStoreName!}</a></span>
