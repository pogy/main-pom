...
<#list [{"fields":[{"name":"rid","value":""+query.rid},{"name":"pid","value":""+query.pid},{"name":"sid","value":""+query.sid},{"name":"sort","value":""+query.sort},{"name":"keyword","value":""+query.keyword},{"name":"page","value":""+query.page}]}] as $it>
<#if $it.fields??>
<form id="wgt_search">
