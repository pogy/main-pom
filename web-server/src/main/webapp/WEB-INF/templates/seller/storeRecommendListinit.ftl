...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/gys3/css/storeRecommendListinit.css" rel="stylesheet">
...
<script src="http://style.571xz.com/gys3/js/storeRecommendListinit.js"></script>
