...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/gys4/css/storeRecommendListinit.css?t=" rel="stylesheet">
...
<script src="http://style.571xz.com/gys4/js/storeRecommendListinit.js?t="></script>
