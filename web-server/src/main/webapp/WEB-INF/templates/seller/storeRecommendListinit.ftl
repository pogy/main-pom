...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/gys4/css/storeRecommendListinit.css?t=1494492255368" rel="stylesheet">
...
<div class="wrapper layout">
    ...
    <div class="content shadow-box">
        <div class="goods-tabbox clearfix">
            <div class="tabbutton"><a href="${main_host!}seller/storeGoodsList21init.htm">出售中的宝贝<em>${goods_counts.sale!}</em></a></div>
            <div class="splitline"></div>
            <div class="tabbutton selected"><a href="${main_host!}seller/storeRecommendListinit.htm">推荐宝贝<em>${goods_counts.tj!}</em></a></div>
        </div>
        ...
        <div class="goods-list">
            <ul class="head clearfix">
                <li class="name">
                    ...
                    <button class="qxgoods">取消推荐</button>
                </li>
                <li class="price">批发价(元)</li>
                <li class="lowestPrice">最低零售价(元)</li>
                <li class="upshelftime">推荐时间</li>
            ...
            <ul class="body clearfix" data-id="${item.id!}">
                <li class="name">
                    <input type="checkbox" class="checkbox" value="${item.id!},1">
                ...
                <li class="upshelftime">${item.time!}</li>
                <li class="control">
                    <button class="qxgoods">取消推荐</button>
                </li>
            </ul>
...
<script src="http://style.571xz.com/gys4/js/storeRecommendListinit.js?t=1494492255368"></script>
