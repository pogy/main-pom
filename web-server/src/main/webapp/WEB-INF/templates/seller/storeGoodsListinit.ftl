...
<html>
  <head>
    ...
    <title>四季星座网-供应商中心-仓库中的宝贝</title>
    ...
    <link href="http://style.571xz.com/gys5/css/storeGoodsListinit.css?t=1501149293773" rel="stylesheet">
...
<div class="sidebar shadow-box">
    ...
    <ul>
        ...
        <li><a class="selected"  href="${main_host!}seller/storeGoodsListinit.htm?pinteger=2">仓库中的商品</a></li> 
...
<li><label>宝贝货号：</label><input id="goodsNo" class="textinput" value="${get.goodsNo!}"></li>                    <li><label>淘宝宝贝ID：</label><input id="goodsId" class="textinput" value="${get.goodsId!}"></li>
        ...
        <div class="goods-list"> <!--333-->
            ...
            <ul class="body clearfix" data-id="${item.id!}">
                <li class="name">
                    <input class="checkbox" type="checkbox" autocomplete="off" value="${item.id!}">
                    <a class="piclink" href="${item.href!}" title="查看宝贝详情" target="_blank">
                        <img src="${item.imgsrc!}_80x80.jpg">
                    </a>
                    <p>
                        <a class="title" href="${item.href!}" title="查看宝贝详情" target="_blank">${item.title!}</a>
...
<script src="http://style.571xz.com/gys5/js/storeGoodsListinit.js?t=1501149293773"></script>
