...
<html>
  <head>
    ...
    <title>四季星座网-供应商中心-修改个人设置</title>
    ...
    <link href="http://style.571xz.com/gys5/css/sysSetsindex.css?t=1501149291558" rel="stylesheet">
...
<div class="sidebar shadow-box">
    ...
    <ul>
        ...
        <li><a class="selected"  href="${main_host!}seller/sysSetsindex.htm">个人信息</a></li> 
    </ul> 
    <h2>营销管理</h2>
    <ul>
...
<script src="http://style.571xz.com/gys5/js/sysSetsindex.js?t=1501149291558"></script>
