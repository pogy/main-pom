...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/gys5/css/releaseGoodsinit.css?t=1501149289280" rel="stylesheet">
...
<div class="sidebar shadow-box">
    ...
    <ul>
        ...
        <li><a href="${main_host!}seller/pictureSpace.htm"  >图片空间</a></li> 
    ...
    <div class="content shadow-box">
        <div class="category-history">
            您最近使用的类目：
            <select id="category-history-select" autocomplete="off">
        ...
        <div class="category-list clearfix">
            ...
            <div class="category-container" data-level="0">
                <ul>
                    <li data-cid="30" data-child="1">男装<i class="iconfont">&#xe655;</i></li>
                    <li data-cid="50011740" data-child="1">流行男鞋<i class="iconfont">&#xe655;</i></li>
                    <li data-cid="16" data-child="1">女装/女士精品<i class="iconfont">&#xe655;</i></li>
                    <li data-cid="50006843" data-child="1">女鞋<i class="iconfont">&#xe655;</i></li>
                    <li data-cid="50006842" data-child="1">箱包皮具/热销女包/男包<i class="iconfont">&#xe655;</i></li>
                    <li data-cid="1625" data-child="1">女士内衣/男士内衣/家居服<i class="iconfont">&#xe655;</i></li>
                    <li data-cid="50010404" data-child="1">服饰配件/皮带/帽子/围巾<i class="iconfont">&#xe655;</i></li>
                    <li data-cid="50008165" data-child="1">童装/童鞋/亲子装<i class="iconfont">&#xe655;</i></li>
                    <li data-cid="50013886" data-child="1">户外/登山/野营/旅行用品<i class="iconfont">&#xe655;</i></li>
                </ul>
            </div>
            
            <div class="category-container" data-level="1">
                <ul>
                    ...
                    <li data-cid="124730001" data-child="1">套装<i class="iconfont">&#xe655;</i></li>
                </ul>
            </div>
            
            <div class="category-container" data-level="2"></div>
            <div class="category-container" data-level="3"></div>
        ...
        <div class="category-tips">
            <div class="msgbox-1">
                <i></i>
                <div class="inner">
                    <em>您当前选择的类目是：</em><span class="current-category"></span>
                </div>
            </div>
...
<#assign text>{"id":'submit-category', "text":'现在发布宝贝'}</#assign>
<#assign $it=text?eval />
                    
                <button class="button-base button-1" id="submit-category">现在发布宝贝</button>
...
<script src="http://style.571xz.com/gys5/js/releaseGoodsinit.js?t=1501149289280"></script>
