...
<#include "/common/host_config.ftl">
    ...
    <link href="http://style.571xz.com/v2/gysV1/css/iwantToRechargein5.css" rel="stylesheet">
    ...
    <script src="http://style.571xz.com/v2/gysV1/js/iwantToRechargein5.js"></script>
</head>
<body>
...
<div class="wrapper layout">
    ...
    <h1></h1>
    <div class="czCon">
    <p><label>充值金额：</label><input type="text" id="money" placeholder="请输入充值金额">元</p>
    <p><label>充值方式：</label><span class="fc3">支付宝</span></p>
    <p>
