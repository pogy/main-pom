...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/gys5/css/releaseGoodsSend.css?t=1501149303117" rel="stylesheet">
...
<#assign text>{"text":'确认并发布宝贝', "id":'dosubmit'}</#assign>
<#assign $it=text?eval />
...
<script src="http://style.571xz.com/gys5/js/releaseGoodsSend.js?t=1501149303117"></script>
