...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/gys5/css/shiguStoreerjiyuming.css?t=1501149308468" rel="stylesheet">
...
<div class="sidebar shadow-box">
    ...
    <ul>
        ...
        <li><a class="selected"  href="${main_host!}seller/shiguStoreerjiyuming.htm">二级域名</a></li> 
    ...
    <div class="content shadow-box">
        <div class="inner">
            <form action="shiguStoreerjiyuming.htm" id="register_form" method="post">
            <h3>输入您的店铺二级域名：</h3>
            <p class="inputbox">http:// <input class="textInput" name="domain" id="domain" onblur="IsURL_2(this.value)" value="${domain!}" type="text"> .571xz.com<#assign text>{"id":'dosubmit', "text":'确认'}</#assign>
<#assign $it=text?eval />
    
        <button class="button-base button-1" id="dosubmit">确认</button>
    
    
            <span class="tips">${msg!}</span></p>
...
<script src="http://style.571xz.com/gys5/js/shiguStoreerjiyuming.js?t=1501149308468"></script>
