...
<html>
  <head>
    ...
    <title>四季星座网-供应商中心-批量修改货号</title>
    ...
    <link href="http://style.571xz.com/gys5/css/storeGoodsNoListinit.css?t=1501149307735" rel="stylesheet">
...
<div class="sidebar shadow-box">
    ...
    <ul>
        ...
        <li><a class="selected"  href="${main_host!}seller/storeGoodsNoListinit.htm">批量修改货号</a></li> 
        ...
        <div class="gntable">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="goods_img"><input type="hidden" class="goodsId" value="${goods.itemId!}"><a href="http://${webSite!}.571xz.com/item.htm?id=${goods.itemId!}" target="_blank"><img src="${goods.picUrl!}_80x80.jpg" width=80 height=80 /></a></td>
...
<script src="http://style.571xz.com/gys5/js/storeGoodsNoListinit.js?t=1501149307735"></script>
