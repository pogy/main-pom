...
<html>
  <head>
    ...
    <title>广告派位申请中-供应商后台-[四季星座网]</title>
    ...
    <link href="http://style.571xz.com/gys5/css/dtggapplyinfo.css?t=1501149293102" rel="stylesheet">
...
<div class="sidebar shadow-box">
    ...
    <div class="content shadow-box">
        ...
        <div class="applyInfo">
            <div class="bsTip">
                <p><i class="iconfont">&#xe6e6;</i>申请资料已提交</p>
            </div>
            <ul>
...
<script src="http://style.571xz.com/gys5/js/dtggapplyinfo.js?t=1501149293102"></script>
