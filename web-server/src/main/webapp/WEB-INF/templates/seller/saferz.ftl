...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/gys5/css/saferz.css?t=1501149302353" rel="stylesheet">
...
<div class="sidebar shadow-box">
    ...
    <div class="content shadow-box">
        ...
        <ul class="formbox">
            <li class="clearfix">
                <label>身份证号码：</label>
                <input class="textinput" id="cardid" placeholder="请输入您的身份证号码" maxlength="18" value="${identity.cardnum!}">
            </li>
            <li class="clearfix">
                <label>身份证照片：</label>
                <div class="picbox<#if identity.imgurl1??> on</#if>" >
                    <#if identity.imgurl1??>
            ...
            <#if identity.msg??>
            <li class="clearfix">
                <p class="tip"><i class="iconfont">&#xe67e;</i>${identity.msg!}</p>
            </li>
            </#if>
            <li class="clearfix">
...
<script src="http://style.571xz.com/gys5/js/saferz.js?t=1501149302353"></script>
