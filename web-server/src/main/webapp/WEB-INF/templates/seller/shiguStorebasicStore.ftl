...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/gys4/css/shiguStorebasicStore.css?t=" rel="stylesheet">
...
<script src="http://style.571xz.com/gys4/js/shiguStorebasicStore.js?t="></script>
