...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/gys5/css/safexgmm.css?t=1501149304677" rel="stylesheet">
    ...
    <div class="content shadow-box">
        ...
        <ul class="formbox">
            ...
            <li class="clearfix" style="display:none">
                <label>原密码：</label>
                <input type="password" value="fromForget" class="textinput" id="pwd1" placeholder="请输入原密码">
                <input type="text" value="${fromForget.verify!}" name="code" id="code">
            </li>
            <#else>
            <li class="clearfix">
                <label>原密码：</label>
...
<script src="http://style.571xz.com/gys5/js/safexgmm.js?t=1501149304677"></script>
