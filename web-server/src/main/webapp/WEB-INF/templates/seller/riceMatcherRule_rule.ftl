...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/gys4/css/riceMatcherRule_rule.css?t=" rel="stylesheet">
...
<script src="http://style.571xz.com/gys4/js/riceMatcherRule_rule.js?t="></script>
