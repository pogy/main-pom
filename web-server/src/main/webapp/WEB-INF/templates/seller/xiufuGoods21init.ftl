...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/gys5/css/xiufuGoods21init.css?t=1501149301620" rel="stylesheet">
...
<div class="sidebar shadow-box">
    ...
    <ul>
        ...
        <li><a class="selected"  href="${main_host!}seller/xiufuGoods21init.htm">商品类目管理</a></li> 
    </ul> 
    <h2>店铺管理</h2>
    <ul>
    ...
    <div class="content shadow-box">
        <div class="goods-tabbox clearfix">
            <div class="tabbutton selected"><a href="JavaScript:;">商品类目管理</a></div>
        </div>
        ...
        <p class="buttonCen" data-id="${session_user_redis__.logshop.shopId!}"><#assign text>{"jbtn":'tbGoodsCate', "text":'同步商品类目'}</#assign>
<#assign $it=text?eval />
            <button class="gyButton " jbtn="tbGoodsCate" id="">同步商品类目</button>
...
<script src="http://style.571xz.com/gys5/js/xiufuGoods21init.js?t=1501149301620"></script>
