...
<html>
  <head>
    ...
    <title>广告派位申请-供应商后台-[四季星座网]</title>
    ...
    <link href="http://style.571xz.com/gys5/css/dtggapply.css?t=1501149292353" rel="stylesheet">
    ...
    <div class="content shadow-box">
        ...
        <div class="applyForm">
            ...
            <ul class="formbox">
                ...
                <li><label><em class="c_ff4400">*</em>联系人：</label><input name="lxuser" value="${lxuser!}"></li>
                <li><label><em class="c_ff4400">*</em>联系电话：</label><input name="lxtel" value="${lxtel!}" ></li>
                <li><label>&nbsp;</label><#assign text>{"text":'提交申请'}</#assign>
<#assign $it=text?eval />
        
            <button class="button-base button-1" >提交申请</button>
...
<script src="http://style.571xz.com/gys5/js/dtggapply.js?t=1501149292353"></script>
