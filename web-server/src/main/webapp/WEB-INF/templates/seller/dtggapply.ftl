...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/gys3/css/dtggapply.css" rel="stylesheet">
...
<#assign $it=text?eval />
    ...
    <script>/*============ gys3/dtggapply#main BEGIN ============*/

var msg = '${msg!}';

/*============ gys3/dtggapply#main END ============*/
...
<script src="http://style.571xz.com/gys3/js/dtggapply.js"></script>
