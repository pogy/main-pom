...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/gys3/css/fitmentStorefitmentStore.css" rel="stylesheet">
...
<script src="http://style.571xz.com/gys3/js/fitmentStorefitmentStore.js"></script>
