    ...
    <div class="fastnav-list">
        ...
        <div class="list j-list" data-id="j-childclo">
            ...
            <ul class="clearfix">
                ...
                <li><a target="_blank" href="http://so.571xz.com/jxgoods.htm?keyword=校服&amp;pid=703">校服/校服定制</a></li>
