...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/indexV4/css/hzMan.css?t=1495419750474" rel="stylesheet">
...
/*============ indexV4/page#layoutHeader END ============*/
    ...
    <script src="http://style.571xz.com/indexV4/js/hzMan.js?t=1495419750474"></script>
  </head>
<body >
                ...
                <div class="list" data-menuid="manMarket">
                    ...
                    <div class="mlist">
                        <ul class="clearfix">
                            ...
                            <li><a target="_blank" href="http://${webSite!}.571xz.com/market.htm?mid=17">大码男装</a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="innerbox w320c2 manMarket" data-width="w320c2">
                        <div class="itemConTop">
                            ...
                            <ul class="itemlist clearfix">
                                ...
                                <li><a href="http://${webSite!}.571xz.com/market.htm?mid=17" target="_blank">大码男装</a></li>
