...
<head>
    ...
    <link rel="stylesheet" href="${back_man_host}/sysman/css/font-awesome.min.css" />
...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main">
            <div class="admin-login-box">
                <a class="logo" style="left: 0;" href="#">
                    <span style="font-size: 22px;">四季星座管理后台</span>
                </a>
        ...
        <div class="layui-tab admin-nav-card layui-tab-brief" lay-filter="admin-tab">
            ...
            <div class="layui-tab-content" style="min-height: 150px; padding: 5px 0 0 0;">
                <div class="layui-tab-item layui-show">
                    <iframe src="${back_man_host}/sysman/index/rightPanel.htm"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <#if loginName == 'dlenton'>
        <script type="text/javascript" src="${back_man_host}/sysman/datas/spread_nav.js"></script>
    <#elseif loginName == 'spreadman'>
        <script type="text/javascript" src="${back_man_host}/sysman/datas/spread_nav_man.js"></script>
    <#elseif loginName == 'spreadwen'>
