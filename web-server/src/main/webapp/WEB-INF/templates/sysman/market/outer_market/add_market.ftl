    ...
    <form class="layui-form" action="" id="submitForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input style="width:200px;" type="text" name="marketName" autocomplete="off" placeholder="请输入市场显示名称" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    ...
                    <input style="width:200px;" type="text" name="sjmarketName" id="marketName" autocomplete="off" placeholder="选择实际市场" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" type="button" onclick="addOutMarket()">立即提交</button>
            </div>
        </div>
    </form>
...
<script>
    ...
    // 新增市场
    function addOutMarket(){
        var datajson = $("#submitForm").serialize();
        var index = parent.layer.getFrameIndex(window.name);
        var loadi = layer.load();
        $.ajax({
            type : "POST",
            url : getRealPath() + '/sysman/outmarket/addOutMarket.json',
            data : datajson,
            dataType : "json",
            async : true,
