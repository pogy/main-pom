    ...
    <form class="layui-form" action="" id="submitForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input style="width:200px;" type="text" name="showName" autocomplete="off" placeholder="请输入显示名称" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <input type="hidden" name="floorIds" id ="marketIds"/>
                    <input style="width:500px;" type="text" name="sjmarketName" id="marketName" autocomplete="off" placeholder="选择实际楼层" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" name="sortOrder" lay-verify="number" autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">数字越大越靠后</div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" type="button" onclick="addOutFloor()">立即提交</button>
            </div>
        </div>
    </form>
...
<script>
    ...
    // 新增楼层
    function addOutFloor(){
        var datajson = $("#submitForm").serialize();
        var index = parent.layer.getFrameIndex(window.name);
        var loadi = layer.load();
        $.ajax({
            type : "POST",
            url : getRealPath() + '/sysman/outFloor/addOutFloor.json',
            data : datajson,
            dataType : "json",
            async : true,
