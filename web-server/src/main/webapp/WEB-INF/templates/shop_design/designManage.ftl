...
<head>
    ...
    <link rel="stylesheet" href="/design/css/shop/design/page.css" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="/design/js/jquery-min.js"></script>
    <link rel="stylesheet" href="/design/theme/xzw/js/layer/skin/layer.css" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="/design/js/zclip/jquery.zeroclipboard.min.js"></script>
