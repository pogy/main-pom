...
<head>
    ...
    <script type="text/javascript" src="/design/js/shop/design/shop_design.js"></script>
</head>
<body>
...
<#list moduleSet.images as img>
                                        <div class="edit-item J_TEditItem even firstlast">
...
//            else {
            ...
            $.ajax({
                url: '/seller/design/savePiccarouselOption.htm',
                type: 'POST',
                data: params,
                // dataType: 'json',
                success: function (d) {
