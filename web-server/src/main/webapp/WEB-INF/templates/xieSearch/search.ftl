...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/xieSearch/css/search.css?t=1499240635405" rel="stylesheet">
    
    
    <script src="http://style.571xz.com/global/js/jquery.js"></script>
    <script src="http://style.571xz.com/xieSearch/js/search.js?t=1499240635405"></script>
  </head>
<body>
        ...
        <div class="topShopList">
            ...
            <div class="shopbox">
                ...
                <div class="r3">
                    ...
                    <a class="a2" href="http://www.kanxie.com/shop.htm?id=${shop.storeId!}" target="_blank">进入店铺</a>
                </div>
                <div class="r4">
        ...
        <div class="goodslistWindow clearfix">
             ...
             <div class="goodsitem" data-goodsid="${goods.id!}">
                ...
                <p class="p1">
                    ...
                    <p class="goodsNo"><a href="http://www.kanxie.com/item.htm?id=${goods.id!}" target="_blank" title="${goods.goodsNo!}">货号：${goods.highLightGoodsNo!}</a></p>
                    <#else>
                    <p class="title"><a href="http://www.kanxie.com/item.htm?id=${goods.id!}" target="_blank" title="${goods.title!}">${goods.highLightTitle!}</a></p>
                    </#if>
                <div class="p3">
