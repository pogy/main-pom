<div class="searchHeader clearfix">
    <div class="layout">
        <div class="logoLeft yahei">
            <a href="//${webSite!}.571xz.com">
                <img src="//style.571xz.com/v6/common/css/img/xz/mtLogo.png" alt width="168" height="30">
            </a>
            <em id="styleName"></em>
            <div class="styleMenuBox">
                <span class="styleIcon"><i class="icon-list"></i></span>
                <div class="styleMenu">
                    <ul>
                        <#list styleList as item>
                            <li><a href="styleIndex.htm?spid=${item.spid!}">${item.sname!}</a></li>
                        </#list>
                    </ul>
                </div>
            </div>
...
<script modulepath="styleChannel/common#searchHeader">
var sname = '${sname!}'
</script>