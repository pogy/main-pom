...
<html>
  <head>
    ...
    <title>手机号码绑定-[四季星座网]</title>
    <link href="http://style.571xz.com/login/css/userPhoneBind.css" rel="stylesheet">
...
<div class="newlogin">
    ...
    <div class="loginmain">
        <h1>手机号码绑定</h1>
        ${msg!}
    <form method="post" id="phone_form" action="userPhoneBind.htm">
        <div class="login-block">
            <div class="mobilephone">
                <span class="mobileuser">手机号:</span>
                <input type="text" class="mobileipt" id="phone" name="telephone">
...
<script src="http://style.571xz.com/login/js/userPhoneBind.js"></script>
