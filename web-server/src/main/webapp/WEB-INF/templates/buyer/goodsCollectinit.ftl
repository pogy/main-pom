...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/fxs2/css/goodsCollectinit.css?t=1498814566692" rel="stylesheet">
...
<div class="wrapper layout">
    ...
    <div class="tabbox clearfix">
        <div class="tabbutton selected"><a href="${main_host!}member/goodsCollectinit.htm">我的数据包</a></div>
        <div class="splitline"></div>
        <div class="tabbutton"><a href="${main_host!}member/goodsDataPackageinit.htm">已生成的数据包</a></div>
...
<#assign $it=text?eval />
    ...
    <#assign text>{"name":'website', "value":"${website!}", "freemarker":true}</#assign>
<#assign $it=text?eval />
        
            
            <div class="jq_select" data-name="${$it.name!}" data-value="${$it.value!}" data-placeholder="${$it.placeholder!}">
                <button class="jq_select_text">loading...</button>
                <i class="bt_arrow iconfont">&#xe6b9;</i>
                <ul class="jq_select_options"></ul>
            </div>
    ...
    <div class="goodslist">
        <ul class="head clearfix">
            <li class="name">
                ...
                <button jbtn="mk_mydp">生成数据包</button>
            </li>
            <li class="piprice">价格(元)</li>
            <li class="marketname">来源</li>
            <li class="control">操作</li>
        </ul>
        <#list goodslist as goods>
        <ul class="body clearfix" goodsid="${goods.id!}">
            <li class="name">
                <input type="checkbox" class="checkbox" goodsid="${goods.goodsCollectId!}">
            ...
            <li class="marketname">${goods.marketname!}</li>
            <li class="control">
                <button jbtn="mk_mydp" goodsid=${goods.goodsCollectId!}>生成数据包</button>
                <button class="del" jbtn="rmv_mydp" goodsid=${goods.goodsCollectId!}>删除</button>
            </li>
        </ul>
        </#list>
    </div>
...
<script src="http://style.571xz.com/fxs2/js/goodsCollectinit.js?t=1498814566692"></script>
