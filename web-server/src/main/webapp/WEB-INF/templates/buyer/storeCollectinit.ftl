...
<#assign text>{            "fields":[                {"name":'page', "value":${page!}},                {"name":'website', "value":"${website!}"}            ]        }</#assign>
<#assign $it=text?eval />
                    <form id="wgt_search">
            ...
            <ul class="body clearfix">
               ...
               <li class="address">${goods.address!}</li>
                <li class="control">
                    ...
                    <button jbtn="rmv_fvshop" goodsid=${goods.id!}>删除</button>
                </li>
            </ul>
            </#list>
        </div>
