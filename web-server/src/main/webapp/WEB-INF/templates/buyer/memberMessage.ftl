...
<html>
  <head>
    ...
    <title>四季星座网-分销商中心-消息提醒详情</title>
    ...
    <link href="http://style.571xz.com/fxs2/css/memberMessage.css?t=1498814571357" rel="stylesheet">
...
<div class="wrapper layout">
    ...
    <div class="content shadow-box">
        ...
        <div class="tabbox clearfix">
            <div class="tabbutton <#if type == 0>selected</#if>"><a href="${main_host!}member/memberMessage.htm?type=0">所有<em class="c_c_ff4400">${sumCount!}</em></a></div>
            <div class="splitline"></div>
            <div class="tabbutton <#if type == 1>selected</#if>"><a href="${main_host!}member/memberMessage.htm?type=1">系统消息<em class="c_c_ff4400">${sysCount!}</em></a></div>
            <div class="splitline"></div>
            <div class="tabbutton <#if type == 2>selected</#if>"><a href="${main_host!}member/memberMessage.htm?type=2">交易信息<em class="c_c_ff4400">${tradesCount!}</em></a></div>
            <div class="splitline"></div>
            <div class="tabbutton <#if type == 3>selected</#if>"><a href="${main_host!}member/memberMessage.htm?type=3">物流助手<em class="c_c_ff4400">${transCount!}</em></a></div>
            <div class="splitline"></div>
            <div class="tabbutton <#if type == 4>selected</#if>"><a href="${main_host!}member/memberMessage.htm?type=4">星座网活动<em class="c_c_ff4400">${activeCount!}</em></a></div>
        </div>
        ...
        <div class="goodslist">
            <ul class="head clearfix">
                <li class="name">
                    ...
                    <button jbtn="mk_mymsg">批量标记</button>
                    <button jbtn="rmv_mymsg">批量删除</button>
                </li>
                <li class="msgfrom">来源</li>
                <li class="createtime">时间</li>
                <li class="tag">标记</li>
                <li class="control">操作</li>
            </ul>
            <#list msglist as msgs>
            <ul class="body clearfix" msgsid="${msgs.id!}">
                <li class="name">
                    <input type="checkbox" name="msgsck" class="checkbox" msgsid="${msgs.id!}">
                    <div class="title">
                        <span class="title_con">${msgs.title!}</span>
                    </div>
                </li>
                <li class="msgfrom">
                    <#if msgs.type == 1>系统消息<#elseif msgs.type == 2>交易信息<#elseif msgs.type == 3>物流助手<#elseif msgs.type == 4>星座网活动</#if>
                </li>
                <li class="createtime">${msgs.createtime!}</li>
                <li class="tag"><i class="iconfont <#if msgs.status == '1'>c_c_ff4400</#if>">&#xe67f;</i></li>
                <li class="control">
                    <#if msgs.status == '1'>
                    <button class="unread" jbtn="mk_mymsg" msgsid=${msgs.id!}>标为已读</button>
                    <#else>
                    <span>已读</span>
                    </#if>
                    <button class="del" jbtn="rmv_mymsg" msgsid=${msgs.id!}>删除</button>
                </li>
            </ul>
            </#list>
        </div>
...
<#assign text>{        "fields":[            {"name":"type", "value":"${type!}"}        ]    }</#assign>
<#assign $it=text?eval />
            <form id="wgt_search">
...
<script src="http://style.571xz.com/fxs2/js/memberMessage.js?t=1498814571357"></script>
