...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/fxs2/css/shiguOnekeyRecordinit.css" rel="stylesheet">
...
<script src="http://style.571xz.com/fxs2/js/shiguOnekeyRecordinit.js"></script>
