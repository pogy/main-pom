...
<html>
  <head>
    ...
    <title>四季星座网-分销商中心-已上传的商品</title>
    ...
    <link href="http://style.571xz.com/fxs2/css/shiguOnekeyRecordinit.css?t=1498441433442" rel="stylesheet">
...
<#assign text>{        "fields":[            {"name":'page', "value":${page!}},            {"name":'startTime', "value":"${get.startTime!}"},            {"name":'endTime', "value":"${get.endTime!}"},            {"name":'target', "value":"${get.target!}"},            {"name":'title', "value":"${get.title!}"}        ]    }</#assign>
<#assign $it=text?eval />
            <form id="wgt_search">
        ...
        <div class="goods_search">
            <ul class="clearfix">
                <li><label>上传对象：</label>
    <#assign text>{"name":'posttype', "value":"${get.target!}","placeholder":'请选择', "freemarker":true}</#assign>
<#assign $it=text?eval />
                ...
                <li><label>上传时间：</label><input name="u_startTime" class="textinput jq_datepicker" value="${get.startTime!}"> 到 <input name="u_endTime" class="textinput jq_datepicker" value="${get.endTime!}"></li>
        ...
        <div class="goodslist">
            <ul class="head clearfix">
                <li class="name">
                    ...
                    <button jbtn="rmv_arddp">批量删除</button>
                </li>
            ...
            <ul class="body clearfix" data-onekeyId="${goods.onekeyId!}">
                ...
                <li class="control">
                    ...
                    <button jbtn="rmv_arddp" goodsid=${goods.onekeyId!}>删除</button>
                </li>
            </ul>
            </#list>
        </div>
...
<script src="http://style.571xz.com/fxs2/js/shiguOnekeyRecordinit.js?t=1498441433442"></script>
