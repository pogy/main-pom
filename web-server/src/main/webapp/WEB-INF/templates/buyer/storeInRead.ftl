...
<head>
    ...
    <title>店铺申请查看 - 分销商中心 - 四季星座网</title>
...
<#include "/common/host_config.ftl">
    ...
    <link href="http://style.571xz.com/v2/fxsV1/css/storeInRead.css?v=2017112301" rel="stylesheet">
    ...
    <script src="http://style.571xz.com/v2/fxsV1/js/storeInRead.js?v=2017112301"></script>
...
<div class="accountInfo">
    ...
    <div class="accountItem">
        ...
        <div class="inner">
            ${applyInfo.cityName!}-${applyInfo.marketName!}-${applyInfo.marketFloorNum!}
        </div>
    </div>
    <div class="accountItem">
        <div class="label"><span class="red">*</span> 售后服务：</div>
        <div class="inner">
            <#if applyInfo.serverLevel == "0">不可退换<#elseif applyInfo.serverLevel == "1">可退<#elseif applyInfo.serverLevel == "2">可换<#else>可退可换</#if>
        </div>
    </div>
</div>
</form>
