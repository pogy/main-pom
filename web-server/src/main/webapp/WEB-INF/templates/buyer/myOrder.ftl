        ...
        <div class="fr">
            <ul class="menuContainer">
                ...
                <#if !session_user_redis__ || $it.isFxs?? ||  !session_user_redis__.logshop>
                    ...
                    <li>
                        <div class="cnBox pr">
                            <a class="cgcom pr" href="${main_host!}member/storeCollectinit.htm">我的收藏<i
                                    class="downArrow"></i></a>
...
<div class="wrapper">
    ...
    <#assign text>{"fields":[{"name":"status","value":"${query.status!}"},{"name":"goodsNo","value":"${query.goodsNo!}
        "},{"name":"st","value":query.st,"timeFormat":"yyyy-MM-dd"},{"name":"et","value":query.et,"timeFormat":"yyyy-MM-dd"},{"name":"orderId","value":"${query.orderId!}
        "},{"name":"receiver","value":"${query.receiver!}"},{"name":"telePhone","value":"${query.telePhone!}
        "},{"name":"orderType","value":"${query.orderType!}"},{"name":"page","value":"${query.page!}"}]}</#assign>
    ...
    <#list [moduledata1] as $it>
        ...
        <div class="rightBox fr">
            ...
            <div class="orderSearch clearfix">
                <ul>
                    <li><label>商品货号：</label><input type=text name="goodsNo"
                                                   <#if query.goodsNo??>value="${query.goodsNo!}"</#if>></li>
                    <li>
                        <label>时间：</label><input type=text class="jqDatepicker slInput" data-format="%Y-%M-%D"
                                                 name="starTime" placeholder="请选择时间范围起始"
                                                 <#if query.st??>value="${query.st?string('yyyy-MM-dd')}"</#if>><span
                            class="divideLine">-</span><input type=text class="jqDatepicker slInput"
                                                              data-format="%Y-%M-%D" name="endTime"
                                                              placeholder="请选择时间范围起始"
                                                              <#if query.et??>value="${query.et?string('yyyy-MM-dd')}"</#if>>
                    </li>
                    <li>
                        <label>订单类型：</label>
                    ...
                    <li><label>订单编号：</label><input type=text name="orderId"
                                                   <#if query.orderId??>value="${query.orderId!}"</#if>></li>
                    <li><label>收货人信息：</label><input type=text name="receiver" placeholder="收货人姓名" class="slInput"
                                                    <#if query.receiver??>value="${query.receiver!}"</#if>><span
                            class="divideLine"></span><input type=text name="telePhone" placeholder="收货人手机号码"
                                                             class="slInput"
                                                             <#if query.telePhone??>value="${query.telePhone!}"</#if>>
                    </li>
                    <li class="marginLeft">
                    <#assign text>{}</#assign>
                            ...
                            <#list order.childOrders as childOrder>
                                <ul class="childOrderItem <#if childOrder_index == (order.childOrders?size) - 1>lastChildOrder</#if> clearfix">
                                    <li class="goods goodsDetail">
                                        ...
                                        <div class="goodsCon">
                                            <a href="http://${order.webSite!}.571xz.com/item.htm?id=${childOrder.goodsId!}"
                                               target="_blank" class="goodsTitle"
                                               title="${childOrder.title!}">${childOrder.title!}</a>
                                            <p class="goodsSku fc9">
                                                颜色：${childOrder.color!}&nbsp;&nbsp;&nbsp;&nbsp;尺码：${childOrder.size!}</p>
                                    ...
                                    <li class="num">
                                        ...
                                        <#if childOrder.stockoutNum??>
                                            <div class="pr stockoutNum">
                                                <p class="fcF40"><i class="icon-c-warn"></i>缺货
                                                    x${childOrder.stockoutNum!}</p>
                                        ...
                                        <#if order.mainState == 2 || order.mainState == 3 || order.mainState == 4>
                                            <#if childOrder.afterSales?? && (childOrder.afterSales?size) gt 0>
                                                <#if childOrder.refundCount != childOrder.num && childOrder.hasAfter == false && order.mainState == 3>
                                                    ...
                                                    <p>
                                                        <a href="${main_host!}order/returnOrChange.htm?childOrderId=${childOrder.childOrderId!}"
                                                           target="_blank" class="fc9">申请售后</a></p>
                                                </#if>
                                                ...
                                                <#list childOrder.afterSales as afterSale>
                                                    <#if afterSale.type == 1>
                                                        <#if afterSale.state == 2>
                                                            <p><a class="fcBlue"
                                                                  href="onlyRefund.htm?refundId=${afterSale.refundId!}"
                                                                  target="_blank">申请退款成功 x${afterSale.afterSaleNum!}</a>
                                                            </p>
                                                        </#if>
                                                    </#if>
                                                    <#if afterSale.type == 2>
                                                        <#if afterSale.state == 2>
                                                            <p><a class="fcF40"
                                                                  href="${main_host!}order/refund.htm?refundId=${afterSale.refundId!}"
                                                                  target="_blank">退货退款完成x${afterSale.afterSaleNum!}</a>
                                                            </p>
                                                        <#elseif afterSale.state == 1>
                                                            <p><a class="fcF40"
                                                                  href="${main_host!}order/refund.htm?refundId=${afterSale.refundId!}"
                                                                  data-id="${afterSale.refundId!}" jbtn="afterSaleBtn"
                                                                  target="_blank">售后处理中<#if afterSale.newAfterSaleInfoIs == true>
                                                                <i class="afterSaleDot"></i></#if></a></p>
                                                        ...
                                                        <#elseif afterSale.state == 3>
                                                            <div class="refuseAfterSale pr">
                                                                <p><a class="fcF40"
                                                                      href="${main_host!}order/refund.htm?refundId=${afterSale.refundId!}"
                                                                      target="_blank"><i class="icon-c-warn"></i>退货申请已拒绝</a>
                                                                </p>
                                                    ...
                                                    <#if afterSale.type == 3>
                                                        <#if afterSale.state == 2>
                                                            <p><a class="fcBlue"
                                                                  href="${main_host!}order/exchange.htm?refundId=${afterSale.refundId!}"
                                                                  target="_blank">换货完成</a></p>
                                                        <#elseif afterSale.state == 1>
                                                            <p><a class="fcF40"
                                                                  href="${main_host!}order/exchange.htm?refundId=${afterSale.refundId!}"
                                                                  data-id="${afterSale.refundId!}" jbtn="afterSaleBtn"
                                                        ...
                                                        <#elseif afterSale.state == 3>
                                                            <div class="refuseAfterSale pr">
                                                                <p><a class="fcF40"
                                                                      href="${main_host!}order/exchange.htm?refundId=${afterSale.refundId!}"
                                                                      target="_blank"><i class="icon-c-warn"></i>换货申请已拒绝</a>
                                                                </p>
                                                                <div class="pa refuseReason fc6">
                                                                ${afterSale.refuseReason!}
                                                                </div>
                                                    ...
                                                    <#if afterSale.type == 4>
                                                        <#if afterSale.state == 2>
                                                            <p><a class="fcBlue"
                                                                  href="onlyRefund.htm?refundId=${afterSale.refundId!}"
                                                                  target="_blank">自动退款 x${afterSale.afterSaleNum!}</a>
                                                            </p>
                                                        </#if>
                                                    </#if>
                                                </#list>
                                            <#else>
                                                <#if order.mainState == 2>
                                                    <p><a href="javascript:;"
                                                          onclick="applyRefund(${childOrder.childOrderId!})">申请退款</a>
                                                    </p>
                                    ...
                                    <li class="orderState">
                                        <#if childOrder_index == 0>
                                            <#if order.mainState == 1>
                                                ...
                                                <#assign text>{"href":"${main_host!}
                                                    order/payMode.htm?orderId=${order.orderId!}"}</#assign>
         ...
         toPay"
                                            ...
                                            <p><a href="${main_host!}order/orderDetail.htm?orderId=${order.orderId!}"
                                                  target="_blank" class="fc9">订单详情</a></p>
                                            <#if order.mainState == 1>
                                                <p><a href="javascript:;" onclick="cancelOrder(${order.orderId!})"
                                                      class="fc9">取消订单</a></p>
                                            <#elseif order.mainState == 3>
                                                <p>
                                                    <a href="${main_host!}order/expressDetail.htm?orderId=${order.orderId!}"
                                                       target="_blank" class="fc9">查看物流</a></p>
                                            </#if>
                                            <#if order.mainState == 3>
                                                <#if order.isTbOrder == true>
                                                    <#if order.isTbShipments == true>
                                                        <p>淘宝已发货</p>
                                                    <#else>
                                                        <p><b class="markingTb" jbtn="markingTb"
                                                              data-id="${order.orderId!}">标记淘宝发货</b></p>
                                                    </#if>
                                                </#if>
                                            </#if>
                                        </#if>
...
<div class="footer">
    <div class="inner">
        ...
        <p class="jyga">
            ...
            <br>
            <a href="http://www.zca.gov.cn/txzf/bulletinLatest.htm?method=getBulletinDetail&amp;id=4063"
               target="_blank">增值电信业务经营许可证： 浙B2-20120165</a>
            |
