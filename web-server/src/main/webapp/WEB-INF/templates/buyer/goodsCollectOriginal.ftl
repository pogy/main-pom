...
<#include "/common/host_config.ftl">
    ...
    <link href="http://style.571xz.com/v2/fxsV1/css/goodsCollectOriginal.css?v=2017112301" rel="stylesheet">
    ...
    <script src="http://style.571xz.com/v2/fxsV1/js/goodsCollectOriginal.js?v=2017112301"></script>
