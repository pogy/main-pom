...
<#include "/common/host_config.ftl">
    ...
    <link href="http://style.571xz.com/v2/fxsV1/css/safeindex.css?v=2017112301" rel="stylesheet">
    ...
    <script src="http://style.571xz.com/v2/fxsV1/js/safeindex.js?v=2017112301"></script>
...
<div class="wrapper">
    ...
    <ul class="clearfix">
        ...
        <li class="d3">
            <#if info_payPwd == true>
            <a href="${main_host!}member/safeXgPaymmForget.htm">找回密码</a>
