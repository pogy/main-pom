...
<#include "/common/host_config.ftl">
    ...
    <link href="http://style.571xz.com/v2/fxsV1/css/tbBindGoodsNo.css?v=2017112301" rel="stylesheet">
    ...
    <script src="http://style.571xz.com/v2/fxsV1/js/tbBindGoodsNo.js?v=2017112301"></script>
...
<div class="rightBox fr">
    ...
    <ul>
        <li class="select"><a href="javascript:;">未关联商品</a></li>
    </ul>
</div>
