...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/fxs2/css/storeIn.css?t=1498441434550" rel="stylesheet">
...
<div class="wrapper layout">
    ...
    <div class="content">
        <div class="tabbox clearfix">
            ...
            <div class="add_store"><a href="${main_host!}ruzhu.htm" target="_blank">添加店铺</a></div>
        </div>
    <div class="storelist">
        <table>
            <thead>
...
<script src="http://style.571xz.com/fxs2/js/storeIn.js?t=1498441434550"></script>
