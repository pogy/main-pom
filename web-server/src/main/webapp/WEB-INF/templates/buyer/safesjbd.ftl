...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/fxs2/css/safesjbd.css?t=1498814572979" rel="stylesheet">
...
<div class="wrapper layout">
    ...
    <div class="content shadow-box">
        ...
        <ul class="formbox">
            <li class="clearfix">
                <label>手机号码：</label>
                <input class="textinput" id="mobile" placeholder="请输入您的手机号码" value="${record.loginPhone!}">
            </li>
            <li class="clearfix c_relative">
                <label>验证码：</label>
                <input class="textinput" id="vcode" placeholder="请输入手机验证码">
                <b class="scode" jbtn="scode">发送验证码</b>
            </li>
            <li class="clearfix">
                            <button
...
<script src="http://style.571xz.com/fxs2/js/safesjbd.js?t=1498814572979"></script>
