...
<html>
  <head>
    ...
    <link href="//style.571xz.com/loginV2/css/forgetPassword.css" rel="stylesheet">
    
    
    <script src="//style.571xz.com/global/js/jquery.js"></script>
    <script src="//style.571xz.com/loginV2/js/forgetPassword.js"></script>
  </head>
<body>
        ...
        <div class="pwdContainer">
            ...
            <div class="pwdForm" style="display:none">
                <div class="updateSuccess">
                    <p>密码修改成功！</p>
                    <div class="successTip"><span class="time">3</span>s 后跳转到<a href="//www.571xz.com">四季星座网首页</a></div>
                </div>
            </div>
        </div>
    </div>
