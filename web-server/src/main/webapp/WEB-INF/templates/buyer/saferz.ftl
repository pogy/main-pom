...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/fxs2/css/saferz.css?t=1498814571872" rel="stylesheet">
        ...
        <ul class="formbox">
            ...
            <li class="clearfix">
                ...
                <div class="picbox<#if identity.imgurl1??> on</#if>" >
                    ...
                    <#else>
                    <img src="http://style.571xz.com/fxs2/css/img/addpic.png">
                    </#if>
                    <p>点击添加正反面</p>
...
<script src="http://style.571xz.com/fxs2/js/saferz.js?t=1498814571872"></script>
