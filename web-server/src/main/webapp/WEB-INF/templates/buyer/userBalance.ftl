...
<#include "/common/host_config.ftl">
    ...
    <link href="http://style.571xz.com/v2/fxsV1/css/userBalance.css?v=2017112301" rel="stylesheet">
    ...
    <script src="http://style.571xz.com/v2/fxsV1/js/userBalance.js?v=2017112301"></script>
...
<div class="header">
    <div class="layout">
        ...
        <ul class="fl fs16 yahei clearfix">
            ...
            <li><a href="${main_host!}member/userBalance.htm" class="selected">我的钱包</a></li>
...
>
    ...
    <h1>资金明细 <a href="${excelUrl!}" class="searchall">导出Excel</a></h1>
    <div class="capSub">
    <table>
        <thead>
            <tr class="thTr">
