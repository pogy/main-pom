...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/fxs2/css/memberfxs.css?t=1495880229010" rel="stylesheet">
...
<div class="header">
    <div class="layout">
        ...
        <ul>
            <li class="selected"><a href="${main_host!}member/index.htm">首页</a></li>
...
<div class="wrapper layout">
    ...
    <div class="content">
    <div class="account-info shadow-box pd30">
        <div class="head-box clearfix">
            ...
            <div class="rt">
                ...
                <p class="button-box clearfix">
                    <a href="${main_host!}member/iwantToRechargein5.htm">充值</a>
                    <a href="${main_host!}member/withdraw5Apply.htm">提现</a>
                </p>
            </div>
        </div>
        ...
        <ul class="icon-list clearfix">
            ...
            <li><i class="img-skjf"></i>上款积分<em>${jifenCount!}</em></li>
        </ul>
        
    </div>
    
    <div class="shop-info shadow-box pd30">
        <h3 class="box-title">淘宝上架店铺动态</h3>
        <div class="shop-box">
            <ul class="clearfix">
...
<script src="http://style.571xz.com/fxs2/js/memberfxs.js?t=1495880229010"></script>
