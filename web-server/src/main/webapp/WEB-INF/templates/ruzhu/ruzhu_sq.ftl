...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/ruzhu_temp/css/ruzhu_sq.css?t=" rel="stylesheet">
        ...
        <div class="content">
            <div class="tip_con">
                ...
                <div class="store_con">
                    ...
                    <p>如您希望快速审核，请把编号 ${query.userCode!} 发给客服。</p>
                    <p class="tosearch"><a href="${main_host!}member/storeIn.htm">立即查看</a></p>
                </div>
            </div>
        </div>
...
<script src="http://style.571xz.com/ruzhu_temp/js/ruzhu_sq.js?t="></script>
