...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/fxs/css/storeInRead.css" rel="stylesheet">
  </head>
<body>
        ...
        <div class="layout rz_content">
            ...
            <div class="accountInfo">
                ...
                <div class="accountItem">
                    ...
                    <div class="inner">
                        <#if applyInfo.hasTaobaoStore == "1">有<#else>没有</#if>
                    </div>
                </div>
                <div class="accountItem">
...
<script src="http://style.571xz.com/fxs/js/storeInRead.js"></script>
