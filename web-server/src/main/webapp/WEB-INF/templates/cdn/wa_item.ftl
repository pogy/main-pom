...
<html>
  <head>
    ...
    <link href="//style.571xz.com/wa_shop_item_temp/css/item.css" rel="stylesheet">
...
<div class="content_top layout">
    <div class="crumbbox">
        <div class="ctWeb_map" >
            <ul class="j_mapCon">
                <li><a href="//${vo.storeRelation.webSite!}.571xz.com/shop.htm?id=${vo.storeRelation.storeId!}&timeflag=2" target="_blank" >所有宝贝</a></li>
            </ul>
        </div>
    </div>
    <div class="leftbox">
            ...
            <div class="proCon">
                ...
                <div class="clearfix">
                    ...
                    <div class="selectsUpc gyselect j_weixin_boss">
                        ...
                        <p class="up_button">
                            <a class="wa_buttion_up" href="//upload.571xz.com/publish.htm?id=${vo.itemId!}&wsit="  title="上传淘宝" target="_blank" >淘宝</a>
                            <a class="wa_buttion_up" href="//1688.571xz.com/offer/publish.htm?id=${vo.itemId!}"  title="上传阿里" target="_blank">阿里</a>
                ...
                <div class="shopIm">
                    <ul>
                        ...
                        <li>
                            ...
                            <span id="alww2">
                                <script type="text/javascript">
                                    function AliStatus(json) {
                                        ...
                                        console.log(stats);
                                        a.innerHTML = '<a href="//www.taobao.com/webww/ww.php?ver=3&touid=${vo.storeRelation.imWw!}&amp;siteid=cntaobao&amp;status=1&amp;charset=utf-8" style="width: 20px;" class="fl c_mf10 ali-base ' + stats + '" target="_blank"></a>';
                                    }
                                </script>
                            ...
                            <#if vo.storeRelation.imQq != ""><a class="fl c_mf10" href="//wpa.qq.com/msgrd?v=3&amp;uin=${vo.storeRelation.imQq!}&amp;site=qq&amp;menu=yes" target="_blank"><img src="//style.571xz.com/global_temp/css/resources2016/images/qq2016.png" width="16" height="18" alt="联系qq"></a></#if>
                        </li>
                    </ul>
                </div>
                <div class="rOperate">
...
<script src="//style.571xz.com/wa_shop_item_temp/js/item.js?t=20170516"></script>
