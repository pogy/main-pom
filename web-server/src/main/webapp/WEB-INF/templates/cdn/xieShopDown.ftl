...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/xieShopItem/css/xieShopDown.css?t=1499166076447" rel="stylesheet">
    
    
    <script src="http://style.571xz.com/global/js/jquery.js"></script>
            <script src="http://style.571xz.com/xieShopItem/js/temp/ekoo.min.js"></script>
    <script src="http://style.571xz.com/xieShopItem/js/xieShopDown.js?t=1499166076447"></script>
  </head>
<body>
