...
<html>
  <head>
    ...
    <link href="http://style.571xz.com/wa_shop_item_temp/css/wa_shopcomment.css" rel="stylesheet">
...
<script src="http://style.571xz.com/wa_shop_item_temp/js/wa_shopcomment.js"></script>
