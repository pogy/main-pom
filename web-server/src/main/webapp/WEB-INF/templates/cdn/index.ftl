...
<html>
  <head>
    ...
    <link href="//style.571xz.com/marketV3/css/index.css?t=2017112302" rel="stylesheet">
...
<div class="header layout">
    <div class="logoLeft">
        <a href="//${webSite!}.571xz.com">
            <img src="//style.571xz.com/marketV3/css/img/mtLogo.png" alt width=168 height=30 />
        </a>
        <em>逛市场</em>
    </div>
    ...
    <div class="search">
        ...
        <div class="searchBox">
            <form id="formSearch" action="//www.571xz.com/storenum.htm?webSite=${webSite!}">
    ...
    <div class="layout navCon">
        ...
        <div class="navList">
            <ul>
                ...
                <#if webSite == 'jx'>
                <li class="select"><a href="//${webSite!}.571xz.com/market.htm?mid=33">逛市场</a></li> 
                <#elseif webSite == 'cs'>
                <li class="select"><a href="//${webSite!}.571xz.com/market.htm?mid=43">逛市场</a></li>
                <#elseif webSite == 'ss'>
                <li class="select"><a href="//${webSite!}.571xz.com/market.htm?mid=62">逛市场</a></li>
                <#else>
                <li class="select"><a href="//${webSite!}.571xz.com/market.htm">逛市场</a></li>
                </#if>
                ...
                <#if webSite == 'hz'>
                <li><a href="//www.571xz.com/shopRanking.htm" target="_blank">排行榜<i class="hot"></i></a></li>
                </#if>
                <li><a href="/daifaIndex.htm" target="_blank">一件代发</a></li>
                <#if webSite == 'hz'>
                <li><a href="//www.571xz.com/shopIconCopyright.htm" target="_blank">知识产权</a></li>
                </#if>
...
<script src="//style.571xz.com/global/js/jquery.js"></script>
        <script src="//style.571xz.com/marketV3/js/jquery.pjax.js"></script>
        <script src="//style.571xz.com/marketV3/js/nprogress.js"></script>
<script src="//style.571xz.com/marketV3/js/index.js?t=2017112301"></script>
