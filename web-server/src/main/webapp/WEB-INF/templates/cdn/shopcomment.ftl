...
<html>
  <head>
    ...
    <link href="//style.571xz.com/shopItemCopy/css/shopcomment.css?t=1496988600266" rel="stylesheet">
    
    
    <script src="//style.571xz.com/global/js/jquery.js"></script>
    <script src="//style.571xz.com/shopItemCopy/js/shopcomment.js?t=1504256451272"></script>
  </head>
<body>
    ...
    <div class="shopInfo">
        ...
        <ul class="contactUl" >
            ...
            <li>
                ...
                <a class="online" href="//wpa.qq.com/msgrd?v=3&amp;uin=${vo.storeRelation.imQq!}&amp;site=qq&amp;menu=yes" target="_blank" style="color:#333"><i class="qq"></i>和我联系</a>
                </#if>
