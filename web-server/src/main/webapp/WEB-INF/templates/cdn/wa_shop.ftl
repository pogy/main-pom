...
<html>
  <head>
    ...
    <link href="//style.571xz.com/wa_shop_item_temp/css/shop.css" rel="stylesheet">
...
<div class="dht clearfix">
    <div class="dhNav">
        <ul class="clearfix">
                ...
                <li class="c_all_cat <#if query.timeflag?? && (query.timeflag == 2 || query.timeflag == 3 || query.timeflag == 5 || query.timeflag == 6)>active</#if>"><a href="//${vo.storeRelation.webSite!}.571xz.com/shop.htm?id=${vo.storeRelation.storeId!}&timeflag=2">全部商品</a><i class="iconfont">&#xe651;</i>
                ...
                <li <#if query.timeflag?? && query.timeflag == 4>class="active"</#if>><a href="//${vo.storeRelation.webSite!}.571xz.com/shop.htm?id=${vo.storeRelation.storeId!}&timeflag=4">下架商品</a></li>
            ...
            <ul class="wa_shop_goods_list clearfix">
                ...
                <li class="j_weixin_boss goodsjg xjgoods">
                    <a target="_blank" href="#" title="${item.title!}">
                        <div class="j_erweima wa_shop_goods_img">
                            <img class="lazyload"  old_src=""  data-original="${item.imgUrl!}_220x220.jpg" src="//style.571xz.com/wa_shop_item_temp/css/img/loading_s.gif" style="zoom: 1;">
                            <i class="iconfont">&#xe67d;</i>
                        </div>
                    </a>
                ...
                <li class="j_weixin_boss goodsjg">
                    ...
                    <p class="wa_shop_button">
                        <a class="wa_shop_buttion_up" href="//upload.571xz.com/publish.htm?id=${item.itemId!}&amp;wsit=1"  title="上传淘宝" target="_blank" >淘宝</a>
                        <a class="wa_shop_buttion_up" href="//1688.571xz.com/offer/publish.htm?id=${item.itemId!}"  title="上传阿里" target="_blank">阿里</a>
...
<script src="//style.571xz.com/global/js/jquery.js"></script>
        <script src="//style.571xz.com/wa_shop_item_temp/temp/ekoo.min.js"></script>
<script src="//style.571xz.com/wa_shop_item_temp/js/shop.js"></script>
