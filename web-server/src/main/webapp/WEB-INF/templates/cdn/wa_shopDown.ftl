...
<html>
  <head>
    ...
    <link href="//style.571xz.com/wa_shop_item_temp/css/wa_shopDown.css" rel="stylesheet">
...
<script src="//style.571xz.com/global/js/jquery.js"></script>
        <script src="//style.571xz.com/wa_shop_item_temp/js/temp/ekoo.min.js"></script>
<script src="//style.571xz.com/wa_shop_item_temp/js/wa_shopDown.js"></script>
