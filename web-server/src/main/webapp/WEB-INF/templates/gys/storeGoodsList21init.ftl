...
">
    ...
    <ul class="funOpe">
        <li>
            ...
            <a href="//zixun.571xz.com/detail.htm?id=726" class="videoPro" target="_blank">主图视频使用指南</a>
        </li>
    </ul>
    ...
    <span>
        ...
        <ul class="funOpe">
            <li>
                ...
                <span>&nbsp;</span>
                <a href="//zixun.571xz.com/detail?id=619" class="bigPicPro" target="_blank">大图设置教程</a>
                <a href="//zixun.571xz.com/affiche/detail.htm?id=726" class="videoPro" target="_blank">主图视频使用指南</a>
            </li>
        </ul>
        <#list goodslist as item>
        <ul class="body clearfix" data-id="${item.id!}">
