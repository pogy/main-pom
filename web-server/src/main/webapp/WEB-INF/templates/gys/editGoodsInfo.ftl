    ...
    <#else>
            ...
            <div class="skuList">
                ...
                <tbody>
                    ...
                    <tr>
                        <#if size_index == 0>
                            <td rowspan="${(sku.sizes?size)!}" data-pvid="${sku.pVid!}" data-text="${sku.pVText!}" class="colorSpeces">${sku.pVText!}</td>
                        </#if>
                        <td data-pvid="${size.pVid!}" data-text="${size.pVText!}" class="sizeSpeces">${size.pVText!}</td>
