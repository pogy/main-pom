...
<#include "/common/host_config.ftl">
    ...
    <link href="http://style.571xz.com/v2/qzhd/css/newPopular4.css?v=20180821" rel="stylesheet">
    ...
    <script src="http://style.571xz.com/v2/qzhd/js/newPopular4.js?v=20180821"></script>
</head>
<body>
