...
<#include "/common/host_config.ftl">
    ...
    <link href="//style.571xz.com/v2/qzhd/css/newPopular6.css?v=2017092901" rel="stylesheet">
    ...
    <script src="//style.571xz.com/v2/qzhd/js/newPopular6.js?v=2017092901"></script>
</head>
<body>
