...
<#include "/common/host_config.ftl">
    ...
    <link href="http://style.571xz.com/v2/qzhd/css/lottery3.css" rel="stylesheet">
    ...
    <script src="http://style.571xz.com/v2/qzhd/js/lottery3.js"></script>
</head>
<body>
...
<div class="rules">
    ...
    <div class="layout rulesBox">
        ...
        <ol>
            <li>1、活动时间：上新及抽奖时间：2017.09.04--2017.09.11日。</li>
