...
<html>
  <head>
    ...
    <link href="//style.571xz.com/fdGoodsV5/css/findGoods1.css?t=1504256331245" rel="stylesheet">
    
    
    <script src="//style.571xz.com/global/js/jquery.js"></script>
    <script src="//style.571xz.com/fdGoodsV5/js/findGoods1.js?t=1504256331245"></script>
  </head>
<body>
        ...
        <div class="layout">
            <div class="leftNav">
                <ul>
                    ...
                    <li><a href="//www.571xz.com/activity/redbull.htm" class="select">发现好货</a><span></span></li>
                </ul>
            </div>
            <div class="rightNav">
                <ul>
                    <li><a href="//${webSite!}.571xz.com/market.htm">逛市场</a></li>
                    <li><a href="//so.571xz.com/${webSite!}goods.htm">商品库</a></li>
                    <li><a href="//so.571xz.com/newgoods.htm?webSite=${webSite!}">今日新品</a></li>
                    <li><a href="/daifaIndex.htm">一件代发</a></li>
                    <li><a href="//www.571xz.com/shopIconCopyright.htm">知识产权</a></li>
                    <li><a href="//zixun.571xz.com/index">资讯</a></li>
                </ul>
            </div>
...
<div class="detailInfo">
    ...
    <div  class="goodsList layout pr mt" >
                ...
                <ul>
                    ...
                    <li>
                        <a href="//hz.571xz.com/item.htm?id=${goodsItem.goodsId!}" target="_blank">
                            <img src="${goodsItem.imgSrc!}_300x300.jpg" alt="${goodsItem.title!}" >
                        </a>
                        <h4 class="text-333"><a href="//hz.571xz.com/item.htm?id=${goodsItem.goodsId!}" target="_blank">${goodsItem.title!}</a></h4>
                        <div class="goodsInfo clearfix pr text-f40">
                            <span class="goodsPrice"><i>&yen;</i>${goodsItem.piPriceString!}</span>
                            <a class="goodAddr text-999 pr" href="//hz.571xz.com/shop.htm?id=${goodsItem.shopId!}" target="_blank" title="${goodsItem.marketName!} ${goodsItem.shopNum!}"><i></i>${goodsItem.marketName!} ${goodsItem.shopNum!}</a>
                        </div>
                    </li>
                    </#list>
                </ul>
