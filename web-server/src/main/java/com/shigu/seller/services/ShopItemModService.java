...
//        example1.createCriteria().andStyleTypeEqualTo(0);
//        List<ShiguCustomerStyle> list1 = shiguCustomerStyleMapper.selectByExample(example1);
//        List<ShiguStyleVo> styleVos = BeanMapper.mapList(list1, ShiguStyleVo.class);
//        return styleVos;
//    }
//    /**
//     * 获取自定义风格
...
//            if (goodsNo!=null&&goods.getGoodsNo().equals(goodsNo)){
