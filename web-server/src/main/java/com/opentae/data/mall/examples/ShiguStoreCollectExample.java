...
public class ShiguStoreCollectExample extends SgExample<ShiguStoreCollectExample.Criteria> {
    ...
    public static class Criteria extends SgExample.GeneratedCriteria<Criteria> {
        ...
        public ShiguStoreCollectExample.Criteria andLastTimeIsNull() {
            return isNull(lastTime);
        }

        public ShiguStoreCollectExample.Criteria andLastTimeIsNotNull() {
            return isNotNull(lastTime);
        }

        public ShiguStoreCollectExample.Criteria andLastTimeEqualTo(Date value) {
            return equalTo(lastTime, value);
        }

        public ShiguStoreCollectExample.Criteria andLastTimeNotEqualTo(Date value) {
            return notEqualTo(lastTime, value);
        }

        public ShiguStoreCollectExample.Criteria andLastTimeGreaterThan(Date value) {
            return greaterThan(lastTime, value);
        }

        public ShiguStoreCollectExample.Criteria andLastTimeGreaterThanOrEqualTo(Date value) {
            return greaterThanOrEqualTo(lastTime, value);
        }

        public ShiguStoreCollectExample.Criteria andLastTimeLessThan(Date value) {
            return lessThan(lastTime, value);
        }

        public ShiguStoreCollectExample.Criteria andLastTimeLessThanOrEqualTo(Date value) {
            return lessThanOrEqualTo(lastTime, value);
        }

        public ShiguStoreCollectExample.Criteria andLastTimeIn(List<Date> values) {
            return in(lastTime, values);
        }

        public ShiguStoreCollectExample.Criteria andLastTimeNotIn(List<Date> values) {
            return notIn(lastTime, values);
        }

        public ShiguStoreCollectExample.Criteria andLastTimeBetween(Date value1, Date value2) {
            return between(lastTime, value1, value2);
        }

        public ShiguStoreCollectExample.Criteria andLastTimeNotBetween(Date value1, Date value2) {
        ...
        public ShiguStoreCollectExample.Criteria andSortOrderEqualTo(Integer value) {
            return equalTo(sortOrder, value);
        }

        public ShiguStoreCollectExample.Criteria andSortOrderNotEqualTo(Integer value) {
            return notEqualTo(sortOrder, value);
        }

        public ShiguStoreCollectExample.Criteria andSortOrderGreaterThan(Integer value) {
            return greaterThan(sortOrder, value);
        }

        public ShiguStoreCollectExample.Criteria andSortOrderGreaterThanOrEqualTo(Integer value) {
            return greaterThanOrEqualTo(sortOrder, value);
        }

        public ShiguStoreCollectExample.Criteria andSortOrderLessThan(Integer value) {
            return lessThan(sortOrder, value);
        }

        public ShiguStoreCollectExample.Criteria andSortOrderLessThanOrEqualTo(Integer value) {
            return lessThanOrEqualTo(sortOrder, value);
        }

        public ShiguStoreCollectExample.Criteria andSortOrderIn(List<Integer> values) {
            return in(sortOrder, values);
        }

        public ShiguStoreCollectExample.Criteria andSortOrderNotIn(List<Integer> values) {
            return notIn(sortOrder, values);
        }

        public ShiguStoreCollectExample.Criteria andSortOrderBetween(Integer value1, Integer value2) {
            return between(sortOrder, value1, value2);
        }

        public ShiguStoreCollectExample.Criteria andSortOrderNotBetween(Integer value1, Integer value2) {
