...
public class ShiguShop implements Serializable{
    private static final long serialVersionUID = 6927601825300847978L;
    /**
     * 主键
     */
    @Id
     ...
     */
    @Transient
    private String shopTagsContexts;
    ...
    public String getShopTagsContexts() {
        return shopTagsContexts;
    }

    public void setShopTagsContexts(String shopTagsContexts) {
        this.shopTagsContexts = shopTagsContexts;
    }
