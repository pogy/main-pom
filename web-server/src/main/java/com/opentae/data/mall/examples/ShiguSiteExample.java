...
public class ShiguSiteExample extends SgExample<ShiguSiteExample.Criteria> {
    ...
    public static EntityColumn serialVersionUID;
    ...
    static {
        ...
        serialVersionUID = listMap.get("serialVersionUID");
