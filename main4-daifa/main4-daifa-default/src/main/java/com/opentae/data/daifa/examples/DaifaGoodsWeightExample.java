...
public class DaifaGoodsWeightExample extends SgExample<DaifaGoodsWeightExample.Criteria> {
    ...
    public static class Criteria extends SgExample.GeneratedCriteria<Criteria> {
        ...
        public Criteria andGoodsWeightEqualTo(Long value) {
            return equalTo(goodsWeight, value);
        }

        public Criteria andGoodsWeightNotEqualTo(Long value) {
            return notEqualTo(goodsWeight, value);
        }

        public Criteria andGoodsWeightGreaterThan(Long value) {
            return greaterThan(goodsWeight, value);
        }

        public Criteria andGoodsWeightGreaterThanOrEqualTo(Long value) {
            return greaterThanOrEqualTo(goodsWeight, value);
        }

        public Criteria andGoodsWeightLessThan(Long value) {
            return lessThan(goodsWeight, value);
        }

        public Criteria andGoodsWeightLessThanOrEqualTo(Long value) {
            return lessThanOrEqualTo(goodsWeight, value);
        }

        public Criteria andGoodsWeightIn(List<Long> values) {
            return in(goodsWeight, values);
        }

        public Criteria andGoodsWeightNotIn(List<Long> values) {
            return notIn(goodsWeight, values);
        }

        public Criteria andGoodsWeightBetween(Long value1, Long value2) {
            return between(goodsWeight, value1, value2);
        }

        public Criteria andGoodsWeightNotBetween(Long value1, Long value2) {
