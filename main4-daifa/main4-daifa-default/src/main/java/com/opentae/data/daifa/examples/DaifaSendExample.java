...
public class DaifaSendExample extends SgExample<DaifaSendExample.Criteria> {
    ...
    public static class Criteria extends SgExample.GeneratedCriteria<Criteria> {
        ...
        public Criteria andDaifaSendCodeIsNull() {
            return isNull(daifaSendCode);
        }

        public Criteria andDaifaSendCodeIsNotNull() {
            return isNotNull(daifaSendCode);
        }

        public Criteria andDaifaSendCodeEqualTo(String value) {
            return equalTo(daifaSendCode, value);
        }

        public Criteria andDaifaSendCodeNotEqualTo(String value) {
            return notEqualTo(daifaSendCode, value);
        }

        public Criteria andDaifaSendCodeGreaterThan(String value) {
            return greaterThan(daifaSendCode, value);
        }

        public Criteria andDaifaSendCodeGreaterThanOrEqualTo(String value) {
            return greaterThanOrEqualTo(daifaSendCode, value);
        }

        public Criteria andDaifaSendCodeLessThan(String value) {
            return lessThan(daifaSendCode, value);
        }

        public Criteria andDaifaSendCodeLessThanOrEqualTo(String value) {
            return lessThanOrEqualTo(daifaSendCode, value);
        }

        public Criteria andDaifaSendCodeLike(String value) {
            return like(daifaSendCode, value);
        }

        public Criteria andDaifaSendCodeNotLike(String value) {
            return notLike(daifaSendCode, value);
        }

        public Criteria andDaifaSendCodeIn(List<String> values) {
            return in(daifaSendCode, values);
        }

        public Criteria andDaifaSendCodeNotIn(List<String> values) {
            return notIn(daifaSendCode, values);
        }

        public Criteria andDaifaSendCodeBetween(String value1, String value2) {
            return between(daifaSendCode, value1, value2);
        }

        public Criteria andDaifaSendCodeNotBetween(String value1, String value2) {
