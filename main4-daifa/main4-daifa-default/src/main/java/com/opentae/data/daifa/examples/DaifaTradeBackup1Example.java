...
public class DaifaTradeBackup1Example extends SgExample<DaifaTradeBackup1Example.Criteria> {
    ...
    public static class Criteria extends SgExample.GeneratedCriteria<Criteria> {
        ...
        public Criteria andAfterRemarkIsNull() {
            return isNull(afterRemark);
        }

        public Criteria andAfterRemarkIsNotNull() {
            return isNotNull(afterRemark);
        }

        public Criteria andAfterRemarkEqualTo(String value) {
            return equalTo(afterRemark, value);
        }

        public Criteria andAfterRemarkNotEqualTo(String value) {
            return notEqualTo(afterRemark, value);
        }

        public Criteria andAfterRemarkGreaterThan(String value) {
            return greaterThan(afterRemark, value);
        }

        public Criteria andAfterRemarkGreaterThanOrEqualTo(String value) {
            return greaterThanOrEqualTo(afterRemark, value);
        }

        public Criteria andAfterRemarkLessThan(String value) {
            return lessThan(afterRemark, value);
        }

        public Criteria andAfterRemarkLessThanOrEqualTo(String value) {
            return lessThanOrEqualTo(afterRemark, value);
        }

        public Criteria andAfterRemarkLike(String value) {
            return like(afterRemark, value);
        }

        public Criteria andAfterRemarkNotLike(String value) {
            return notLike(afterRemark, value);
        }

        public Criteria andAfterRemarkIn(List<String> values) {
            return in(afterRemark, values);
        }

        public Criteria andAfterRemarkNotIn(List<String> values) {
            return notIn(afterRemark, values);
        }

        public Criteria andAfterRemarkBetween(String value1, String value2) {
            return between(afterRemark, value1, value2);
        }

        public Criteria andAfterRemarkNotBetween(String value1, String value2) {
