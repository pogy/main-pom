...
public class DaifaSendOrderExample extends SgExample<DaifaSendOrderExample.Criteria> {
    ...
    public static class Criteria extends SgExample.GeneratedCriteria<Criteria> {
        ...
        public Criteria andSendoIdIsNull() {
            return isNull(sendoId);
        }

        public Criteria andSendoIdIsNotNull() {
            return isNotNull(sendoId);
        }

        public Criteria andSendoIdEqualTo(Long value) {
            return equalTo(sendoId, value);
        }

        public Criteria andSendoIdNotEqualTo(Long value) {
            return notEqualTo(sendoId, value);
        }

        public Criteria andSendoIdGreaterThan(Long value) {
            return greaterThan(sendoId, value);
        }

        public Criteria andSendoIdGreaterThanOrEqualTo(Long value) {
            return greaterThanOrEqualTo(sendoId, value);
        }

        public Criteria andSendoIdLessThan(Long value) {
            return lessThan(sendoId, value);
        }

        public Criteria andSendoIdLessThanOrEqualTo(Long value) {
            return lessThanOrEqualTo(sendoId, value);
        }

        public Criteria andSendoIdLike(String value) {
            return like(sendoId, value);
        }

        public Criteria andSendoIdNotLike(String value) {
            return notLike(sendoId, value);
        }

        public Criteria andSendoIdIn(List<Long> values) {
            return in(sendoId, values);
        }

        public Criteria andSendoIdNotIn(List<Long> values) {
            return notIn(sendoId, values);
        }

        public Criteria andSendoIdBetween(Long value1, Long value2) {
            return between(sendoId, value1, value2);
        }

        public Criteria andSendoIdNotBetween(Long value1, Long value2) {
