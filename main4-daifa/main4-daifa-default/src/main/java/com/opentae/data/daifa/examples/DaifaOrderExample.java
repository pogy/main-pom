...
public class DaifaOrderExample extends SgExample<DaifaOrderExample.Criteria> {
    ...
    public static EntityColumn refundMoneyHasItem;
    ...
    static {
        ...
        refundMoneyHasItem = listMap.get("refundMoneyHasItem");
    ...
    public static class Criteria extends SgExample.GeneratedCriteria<Criteria> {
        ...
        public DaifaOrderExample.Criteria andRefundMoneyHasItemIsNull() {
            return isNull(refundMoneyHasItem);
        }

        public DaifaOrderExample.Criteria andRefundMoneyHasItemIsNotNull() {
            return isNotNull(refundMoneyHasItem);
        }

        public DaifaOrderExample.Criteria andRefundMoneyHasItemEqualTo(String value) {
            return equalTo(refundMoneyHasItem, value);
        }

        public DaifaOrderExample.Criteria andRefundMoneyHasItemNotEqualTo(String value) {
            return notEqualTo(refundMoneyHasItem, value);
        }

        public DaifaOrderExample.Criteria andRefundMoneyHasItemGreaterThan(String value) {
            return greaterThan(refundMoneyHasItem, value);
        }

        public DaifaOrderExample.Criteria andRefundMoneyHasItemGreaterThanOrEqualTo(String value) {
            return greaterThanOrEqualTo(refundMoneyHasItem, value);
        }

        public DaifaOrderExample.Criteria andRefundMoneyHasItemLessThan(String value) {
            return lessThan(refundMoneyHasItem, value);
        }

        public DaifaOrderExample.Criteria andRefundMoneyHasItemLessThanOrEqualTo(String value) {
            return lessThanOrEqualTo(refundMoneyHasItem, value);
        }

        public DaifaOrderExample.Criteria andRefundMoneyHasItemLike(String value) {
            return like(refundMoneyHasItem, value);
        }

        public DaifaOrderExample.Criteria andRefundMoneyHasItemNotLike(String value) {
            return notLike(refundMoneyHasItem, value);
        }

        public DaifaOrderExample.Criteria andRefundMoneyHasItemIn(List<String> values) {
            return in(refundMoneyHasItem, values);
        }

        public DaifaOrderExample.Criteria andRefundMoneyHasItemNotIn(List<String> values) {
            return notIn(refundMoneyHasItem, values);
        }

        public DaifaOrderExample.Criteria andRefundMoneyHasItemBetween(String value1, String value2) {
            return between(refundMoneyHasItem, value1, value2);
        }

        public DaifaOrderExample.Criteria andRefundMoneyHasItemNotBetween(String value1, String value2) {
            return notBetween(refundMoneyHasItem, value1, value2);
        }
        ...
        public DaifaOrderExample.Criteria andHaveGoodsDateEqualTo(Date value) {
            return equalTo(haveGoodsDate, value);
        }

        public DaifaOrderExample.Criteria andHaveGoodsDateNotEqualTo(Date value) {
            return notEqualTo(haveGoodsDate, value);
        }

        public DaifaOrderExample.Criteria andHaveGoodsDateGreaterThan(Date value) {
            return greaterThan(haveGoodsDate, value);
        }

        public DaifaOrderExample.Criteria andHaveGoodsDateGreaterThanOrEqualTo(Date value) {
            return greaterThanOrEqualTo(haveGoodsDate, value);
        }

        public DaifaOrderExample.Criteria andHaveGoodsDateLessThan(Date value) {
            return lessThan(haveGoodsDate, value);
        }

        public DaifaOrderExample.Criteria andHaveGoodsDateLessThanOrEqualTo(Date value) {
            return lessThanOrEqualTo(haveGoodsDate, value);
        }

        public DaifaOrderExample.Criteria andHaveGoodsDateIn(List<Date> values) {
            return in(haveGoodsDate, values);
        }

        public DaifaOrderExample.Criteria andHaveGoodsDateNotIn(List<Date> values) {
            return notIn(haveGoodsDate, values);
        }

        public DaifaOrderExample.Criteria andHaveGoodsDateBetween(Date value1, Date value2) {
            return between(haveGoodsDate, value1, value2);
        }

        public DaifaOrderExample.Criteria andHaveGoodsDateNotBetween(Date value1, Date value2) {
