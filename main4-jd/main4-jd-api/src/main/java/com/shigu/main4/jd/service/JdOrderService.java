...
public interface JdOrderService {
     ...
     * @return
     */
    List<JdPostTemplateVO> getPostTemplates(Long jdUid) throws JdAuthFailureException, JdApiException;
     ...
     * @return
     */
    List<JdPostTemplateVO> updatePostTemplates(Long jdUid) throws JdAuthFailureException, JdApiException;
}
