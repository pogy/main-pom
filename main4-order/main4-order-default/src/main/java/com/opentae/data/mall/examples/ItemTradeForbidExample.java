...
public class ItemTradeForbidExample extends SgExample<ItemTradeForbidExample.Criteria> {
    ...
    public static class Criteria extends SgExample.GeneratedCriteria<Criteria> {
        ...
        public ItemTradeForbidExample.Criteria andCanSaleEqualTo(Boolean value) {
            return equalTo(canSale, value);
        }

        public ItemTradeForbidExample.Criteria andCanSaleNotEqualTo(Boolean value) {
            return notEqualTo(canSale, value);
        }

        public ItemTradeForbidExample.Criteria andCanSaleGreaterThan(Boolean value) {
            return greaterThan(canSale, value);
        }

        public ItemTradeForbidExample.Criteria andCanSaleGreaterThanOrEqualTo(Boolean value) {
            return greaterThanOrEqualTo(canSale, value);
        }

        public ItemTradeForbidExample.Criteria andCanSaleLessThan(Boolean value) {
            return lessThan(canSale, value);
        }

        public ItemTradeForbidExample.Criteria andCanSaleLessThanOrEqualTo(Boolean value) {
            return lessThanOrEqualTo(canSale, value);
        }

        public ItemTradeForbidExample.Criteria andCanSaleIn(List<Boolean> values) {
            return in(canSale, values);
        }

        public ItemTradeForbidExample.Criteria andCanSaleNotIn(List<Boolean> values) {
            return notIn(canSale, values);
        }

        public ItemTradeForbidExample.Criteria andCanSaleBetween(Boolean value1, Boolean value2) {
            return between(canSale, value1, value2);
        }

        public ItemTradeForbidExample.Criteria andCanSaleNotBetween(Boolean value1, Boolean value2) {
