 ...
 *
 */
public class KdnCallBackTraceInfo {
	/**
	...
	private List<KdnCallBackTrace> traces;

	public List<KdnCallBackTrace> getTraces() {
		return traces;
	}

	public void setTraces(List<KdnCallBackTrace> traces) {
		this.traces = traces;
	}
