...
public class ItemProductExample extends SgExample<ItemProductExample.Criteria> {
    ...
    public static EntityColumn goodsOneShop;
    ...
    static {
        ...
        goodsOneShop = listMap.get("goodsOneShop");
