...
public class ItemSearchServiceImplTest extends BaseSpringTest {
    ...
    public void search() throws Exception {
        ...
        show(itemSearchService.searchItem("实拍 大货主推】2017年新款蕾丝连衣裙 Q015F65", "hz", null, null, Arrays.asList(stores), null, null, null, null, SearchOrderBy.NEW, 1, 40, true));
    }
...
//        show(itemSearchService.aggsCatsAndMarket("款", "hz",601L,null, null, null, null, null));
    ...
    public void selCategory() throws Exception {
        show(itemSearchService.selCategory(SearchCategory.CATEGORY));
    }
