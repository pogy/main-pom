    ...
    public void sendMsg(){
        ...
        for(ShiguShop s:shopList){
            ...
            if(telephone!=null){
                ...
                System.out.println(sendSms_quick(telephone,"四季星座网温馨提示：\"发现好货\"+\"首页热销\"栏目 共30个位置将在6月1日20点(星期四）开始竞拍，竞拍所得金额将用于回馈代理，请登录四季星座网商家后台或淘宝搜索店名“杭州石谷网络科技有限公司”参与竞拍。退订回复T【四季星座网】"));
