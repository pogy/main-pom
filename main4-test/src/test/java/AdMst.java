...
public class AdMst {
    ...
    @Test
    public void testMsg(){
        System.out.println(sendSms_quick("18888971970","四季星座网温馨提示：“发现好货”栏目 10个位置将在13日20点(今日）开始竞拍，竞拍所得金额将用于回馈代理，请登录商家后台或淘宝搜索”石谷网络“参与竞拍【四季星座网】"));
    }
    @Test
    public void sendMsg(){
        ...
        for(ShiguShop s:shopList){
            ...
            if(telephone!=null){
                ...
                System.out.println(sendSms_quick(telephone,"四季星座网温馨提示：“发现好货”栏目 10个位置将在13日20点(今日）开始竞拍，竞拍所得金额将用于回馈代理，请登录商家后台或淘宝搜索”石谷网络“参与竞拍【四季星座网】"));
            }
