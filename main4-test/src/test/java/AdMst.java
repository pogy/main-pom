...
public class AdMst {
    ...
    @Test
    public void testMsg(){
        System.out.println(sendSms_quick("18888971970","四季星座网温馨提示：（报名时间为5月9日-5月11日12时）网站广告位报名入口已发布，本期总计首页33个位置，轮转播区2个，首页热卖10个，推荐档口8个，元素馆5个，商品库右侧8个（注意：所有广告位不同一区域同一时段内，可重复报名）报名入口为供应商后台【四季星座网】"));
