...
public class DaifaTradeExample extends SgExample<DaifaTradeExample.Criteria> {
    ...
    public static class Criteria extends SgExample.GeneratedCriteria<Criteria> {
        ...
        public DaifaTradeExample.Criteria andSellerIdLike(String value) {
            return like(sellerId, value);
        }

        public DaifaTradeExample.Criteria andSellerIdNotLike(String value) {
        ...
        public DaifaTradeExample.Criteria andGoodsNumEqualTo(Long value) {
            return equalTo(goodsNum, value);
        }

        public DaifaTradeExample.Criteria andGoodsNumNotEqualTo(Long value) {
            return notEqualTo(goodsNum, value);
        }

        public DaifaTradeExample.Criteria andGoodsNumGreaterThan(Long value) {
            return greaterThan(goodsNum, value);
        }

        public DaifaTradeExample.Criteria andGoodsNumGreaterThanOrEqualTo(Long value) {
            return greaterThanOrEqualTo(goodsNum, value);
        }

        public DaifaTradeExample.Criteria andGoodsNumLessThan(Long value) {
            return lessThan(goodsNum, value);
        }

        public DaifaTradeExample.Criteria andGoodsNumLessThanOrEqualTo(Long value) {
            return lessThanOrEqualTo(goodsNum, value);
        }

        public DaifaTradeExample.Criteria andGoodsNumLike(String value) {
            return like(goodsNum, value);
        }

        public DaifaTradeExample.Criteria andGoodsNumNotLike(String value) {
            return notLike(goodsNum, value);
        }

        public DaifaTradeExample.Criteria andGoodsNumIn(List<Long> values) {
            return in(goodsNum, values);
        }

        public DaifaTradeExample.Criteria andGoodsNumNotIn(List<Long> values) {
            return notIn(goodsNum, values);
        }

        public DaifaTradeExample.Criteria andGoodsNumBetween(Long value1, Long value2) {
            return between(goodsNum, value1, value2);
        }

        public DaifaTradeExample.Criteria andGoodsNumNotBetween(Long value1, Long value2) {
        ...
        public DaifaTradeExample.Criteria andExpressIdLike(String value) {
            return like(expressId, value);
        }

        public DaifaTradeExample.Criteria andExpressIdNotLike(String value) {
        ...
        public DaifaTradeExample.Criteria andBuyerIdLike(String value) {
            return like(buyerId, value);
        }

        public DaifaTradeExample.Criteria andBuyerIdNotLike(String value) {
        ...
        public DaifaTradeExample.Criteria andTaobaoTidLike(String value) {
            return like(taobaoTid, value);
        }

        public DaifaTradeExample.Criteria andTaobaoTidNotLike(String value) {
