...
//        DaifaWorkerExample.Criteria ce = example.createCriteria();
    ...
    public int insert(DaifaWorkerBO bo) {
        ...
        return sysDealProcess
                .userInsert(record.getDaifaSellerId(), record.getDfGroupId(), record.getDaifaWorker(), record
                        .getPassword(), record.getUserName(), record.getPhone(), record.getWorkType(), record
                        .getPayBaoAccount(), record.getWorkerId(), record.getRoleId());
    }
     ...
     * @exception: ====================================================================================
     */
    public int update(DaifaWorkerBO record) {
        return sysDealProcess
                .userUpdate(record.getDaifaWorkerId(), record.getDaifaSellerId(), record.getDfGroupId(), record
                        .getDaifaWorker(), record.getPassword(), record.getUserName(), record.getPhone(), record
                        .getWorkType(), record.getPayBaoAccount(), record.getWorkerId(), record.getRoleId(), record
                        .getUseStatus());
    }
