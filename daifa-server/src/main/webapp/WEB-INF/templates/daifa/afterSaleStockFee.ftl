...
<head>
    ...
    <title>售后库存费用 - 星帮后台管理 - 四季星座网</title>
...
<#include "/common/host_config.ftl">
    ...
    <link href="http://style.571xz.com/v2/dfgl/css/afterSaleStockFee.css" rel="stylesheet">
    ...
    <script src="http://style.571xz.com/v2/dfgl/js/afterSaleStockFee.js"></script>
...
<div class="mainContent">
    ...
    <h3 class="fs20">售后-库存（总费用${allStockFee!}元）</h3>
