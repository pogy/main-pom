...
<#include "/common/host_config.ftl">
    ...
    <link href="http://style.571xz.com/v2/dfgl/css/userTakeGoodsDetail.css" rel="stylesheet">
    ...
    <script src="http://style.571xz.com/v2/dfgl/js/userTakeGoodsDetail.js"></script>
