...
<head>
    ...
    <title>统计商品表 - 星帮后台管理 - 四季星座网</title>
...
<!--<link href="http://style.571xz.com/v2/dfgl/css/orderAll.css" rel="stylesheet">-->
    ...
    <script src="${daifa_host}/js/admin/sys/statisGoods/statisGoodsbyGoods.js?t=201711071011"></script>
    <style>
        .ptitle{
            width: 100px;
        ...
        <#list lists as list>
            ...
            <div class="childOrderItem" >
                <ul class="clearfix">
                    ...
                    <li class="tddiv"><p>${list.goodsId!}</p></li>
                    <li class="tddiv"><p>${list.title!}</p></li>
                    <li class="tddiv"><p>${list.goodsCode!}</p></li>
                    <li class="tddiv"><p>${list.storeGoodsCode!}</p></li>
                    <li class="tddiv"><p>${list.singlePiPrice!}</p></li>
