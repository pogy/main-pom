...
<body>
${error}
<form action="${daifa_host}init/adminLogin.htm" method="post">
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="423" height="280" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td><span style="color: #d58512;font-size: xx-large">代发后台系统管理</span></td>
                        </tr>
                    </table></td>
                            ...
                            <td>
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="5">
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="pass" type="password" id="psw" value="${pass}" maxlength="32" vld="{required:true}" class="input"/></td>
                                    </tr>
                                    <tr>
