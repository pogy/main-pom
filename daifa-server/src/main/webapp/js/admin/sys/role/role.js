...
function subdd(){
    ...
    $.post(daifa_host+"admin/roleAdd.json",
        {"roleName":roleName,"createUserId":createUserId,"createUserId":createUserId,"status":status,"roleComment":roleComment,"roleTag":roleTag},
        function(data){
...
function subupdate(){
   ...
   var roleComment=$("#roleComment").val();
    ...
    $.post(daifa_host+"admin/roleEdit.json",
        {"roleId":roleId,"roleName":roleName,"createUserId":createUserId,"createUserId":createUserId,"status":status,"roleComment":roleComment,"roleTag":roleTag},
        function(data){
        if(data.result=="success"){
            alert("修改完成");
        }else{
