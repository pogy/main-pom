...
$(function(){
    $(document).on('click', '[jbtn=searchBtn]', function(){
        $$.search({
            page: 1,
            orderId: $('.orderSearchBox [name=orderId]').val(),
            telephone: $('.orderSearchBox [name=telephone]').val(),
            postCode: $('.orderSearchBox [name=postCode]').val(),
            buyerNick: $('.orderSearchBox [name=buyerNick]').val(),
